...
export function ShareLinkBox({ token }: ShareLinkBoxProps) {
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 bg-[#fafafa] border border-[#eaeaea] rounded-lg px-3 py-2.5">
        <code className="flex-1 text-xs text-[#666] font-mono truncate">{url}</code>
